...
type FreshHarvestPageProps = {
  telegramHandle?: string;
  telegramHref?: string;
  emailHref?: string;
};

export default function FreshHarvestPage({
  telegramHandle = "@mixxxiko",
  telegramHref = "https://t.me/mixxxiko",
  emailHref,
}: FreshHarvestPageProps) {
  return (
    <main className="site-shell">
      ...
      <header className="site-header">
        ...
        <div className="header-actions">
          ...
          <a className="header-contact" href={telegramHref} target="_blank" rel="noreferrer">
        ...
        <div className="proposal-grid section-shell">
          <div className="proposal-copy reveal">
            ...
            <div className="proposal-actions">
              ...
              <a className="proposal-link" href={telegramHref} target="_blank" rel="noreferrer">Получить образцы <ArrowIcon /></a>
            </div>
        ...
        <div className="contact-card reveal">
          <div className="contact-copy">
            ...
            <div className="contact-actions">
              <a className="button button-light" href={telegramHref} target="_blank" rel="noreferrer">
                Написать в Telegram <strong>{telegramHandle}</strong><ArrowIcon />
              </a>
              {emailHref && (
                <a className="button button-light button-mail" href={emailHref}>
                  Написать на почту <ArrowIcon />
                </a>
              )}
            </div>
          </div>
      ...
      <a className="mobile-cta" href={telegramHref} target="_blank" rel="noreferrer">
        Получить образцы <ArrowIcon />
      </a>
    </main>
  );
